...
INSERT INTO portfolio(portfolio_id, created_date, category,	description, is_public, last_modified_date, main_image,	title, view_count, user_id)
VALUES (4, '2019-12-21T08:17:09.478881','programming', '안녕하세요. 포트폴리오3 소개입니다.', true, now(), 'hh', 'user3의 포트폴리오', 1120, 'db3e7741982a40d5919767ac9a0bb94a');
...
-- 회사
INSERT INTO company(company_id, created_date, address, ceo, form, founding_date, homepage, industry, last_modified_date, member_count, name, sales)
VALUES (1, '2017-01-21T08:17:09.478881', '서울특별시 금천구 가산디지털1로 2 (가산동) 1213호 (주)지니프릭스', '지니', '스타트업', '2014년 2월 8일', 'https://www.gnifrix.com', 'IT', now(), '124명', '지니프릭스', '12억');
INSERT INTO company(company_id, created_date, address, ceo, form, founding_date, homepage, industry, last_modified_date, member_count, name, sales)
VALUES (2, '2019-01-21T08:17:09.478881', '서울특별시 강남구 테헤란로77길', '김헬프', '중견기업', '2000년 2월 8일', 'https://www.help-me.kr', '법률/회계', now(), '1124명', '헬프미', '12억');
INSERT INTO company(company_id, created_date, address, ceo, form, founding_date, homepage, industry, last_modified_date, member_count, name, sales)
VALUES (3, '2020-11-29T08:17:09.478882', '서울특별시 강남구 테헤란로11길', '김이구', '중견기업', '2011년 2월 8일', 'https://www.29.co.kr', '패션/디자인', now(), '24명', '29샵', '6억');
...
-- 포트폴리오 저장하기
INSERT INTO user_portfolio(user_portfolio_id, portfolio_id, user_id)
VALUES (1, 1, '067d42d516394118bf54ad37d2f6f61e');
INSERT INTO user_portfolio(user_portfolio_id, portfolio_id, user_id)
VALUES (2, 1, 'db3e7741982a40d5919767ac9a0bb94a');
INSERT INTO user_portfolio(user_portfolio_id, portfolio_id, user_id)
VALUES (3, 2, 'db3e7741982a40d5919767ac9a0bb94a');
INSERT INTO user_portfolio(user_portfolio_id, portfolio_id, user_id)
VALUES (4, 3, '067d42d516394118bf54ad37d2f6f61e');
INSERT INTO user_portfolio(user_portfolio_id, portfolio_id, user_id)
VALUES (5, 4, '3cbe539a33ba4550a82c63be333ac2d0');

-- 기업 공고 저장하기
INSERT INTO user_recruitment(user_recruitment_id, recruitment_id, user_id)
VALUES (1, 1, '067d42d516394118bf54ad37d2f6f61e');
INSERT INTO user_recruitment(user_recruitment_id, recruitment_id, user_id)
VALUES (2, 3, '3cbe539a33ba4550a82c63be333ac2d0');