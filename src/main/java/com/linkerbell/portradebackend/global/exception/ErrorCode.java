...
public enum ErrorCode {
    ...
    // 회원가입
    INVALID_USER_ID("M200", "아이디는 영문 소문자, 숫자만 입력하세요."),
    NULL_USER_ID("M201", "아이디는 필수입니다."),
    INVALID_USER_NAME("M202", "이름을 2~8자 사이로 입력해주세요."),
    NULL_USER_NAME("M203", "이름은 필수입니다."),
    INVALID_USER_PASSWORD("M204", "비밀번호는 영문 대,소문자와 숫자, 특수기호가 적어도 1개 이상씩 포함 8글자 이상이어야 합니다."),
    NULL_USER_PASSWORD("M205", "비밀번호는 필수입니다."),
    NULL_USER_WANTEDJOB("M206", "희망직무는 필수입니다."),
    INVALID_SIZE_USER_BIRTHDATE("M207", "생일은 8글자로 입력해주세요."),
    NULL_USER_BIRTHDATE("M208", "생일은 필수입니다."),
    DUPLICATED_USER_USERNAME("M209", "이미 존재하는 사용자 아이디입니다."),
    ...
    NULL_QNA_EMAIL("Q004", "이메일은 필수입니다."),
    INVALID_QNA_EMAIL("Q005", "올바르지 않은 이메일 형식입니다."),
    NULL_QNA_TITLE("Q006", "제목은 필수입니다."),
    ...
    NONEXISTENT_QNA_ID("Q010", "존재하지 않는 문의글입니다."),
