...
class RecruitmentServiceTest {
    ...
    void createRecruitment() throws Exception {
        ...
        given(companyRepository.findById(anyLong()))
                .willReturn(Optional.ofNullable(company));
    ...
    void getRecruitment() throws Exception {
        //given
        given(recruitmentRepository.findById(anyLong()))
                .willReturn(Optional.ofNullable(recruitment));

        //when
        RecruitmentDetailResponseDto recruitmentDetailResponseDto = recruitmentService.getRecruitment(1L);

        //then
        assertEquals(recruitment.getLogo(), recruitmentDetailResponseDto.getLogo());
        assertEquals(recruitment.getTitle(), recruitmentDetailResponseDto.getTitle());
        assertEquals(recruitment.getCareer(), recruitmentDetailResponseDto.getCareer());
        assertEquals(recruitment.getEducation(), recruitmentDetailResponseDto.getEducation());
        assertEquals(recruitment.getPay(), recruitmentDetailResponseDto.getPay());
        assertEquals(recruitment.getAddress(), recruitmentDetailResponseDto.getAddress());
        assertEquals(recruitment.getCategory(), recruitmentDetailResponseDto.getCategory());
    }
    ...
    void getRecruitments() throws Exception {
        ...
        List<RecruitmentResponseDto> recruitmentResponseDtos = recruitmentsResponseDto.getRecruitments();
